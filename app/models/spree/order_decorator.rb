...
module Spree::OrderDecorator
  self.has_many :amazon_transactions

  self.alias_method :spree_confirmation_required?, :confirmation_required?
  self.alias_method :spree_assign_default_credit_card, :assign_default_credit_card
